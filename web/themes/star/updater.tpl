	...
	<body>
		<div id="mainwrapper">
			...
			<div id="innerwrapper">
				...
				<div id="dialog-placement" style="align:center;display:none;text-align:center;width:892px;margin:0 auto;position:fixed !important;position:absolute;overflow:hidden;top:10px;"> </div>
			...
			<div id="footer">
				<div id="gc">
					By <a href="http://www.interwavestudios.com" target="_blank" class="footer_link">InterWave Studios</a>		
				</div>
				<div id="sb"><br/>
				</div>
				<div id="sm">
